        ...
        suite(`tokenKey`, () => {
          ...
          test(`should be assigned the correct value`, async () => {
            ...
            expect(fakeDefaultGeocoderApiInterface).
              and.not.to.be.undefined().
              and.to.be.instanceof(FakeGeocoderApi);
            expect(fakeDefaultGeocoderApiInterface.tokenKey).
              and.not.to.be.undefined().
              and.to.be.a.string().
              and.to.equal("fakeGoogleTokenKey");
          });
        });
        ...
        suite(`url`, () => {
          ...
          test(`should be assigned the correct value`, async () => {
            ...
            expect(fakeDefaultGeocoderApiInterface).
              and.not.to.be.undefined().
              and.to.be.instanceof(FakeGeocoderApi);
            expect(fakeDefaultGeocoderApiInterface.url).
              and.not.to.be.undefined().
              and.to.be.a.string().
              and.to.equal("fake://maps.googleapis.com/maps/api/geocode/json");
          });
        });
      });
        ...
        suite(`tokenKey`, () => {
          ...
          test(`should be assigned the correct value`, async () => {
            ...
            expect(fakeDefaultTimezoneApiInterface).
              and.not.to.be.undefined().
              and.to.be.instanceof(FakeTimezoneApi);
            expect(fakeDefaultTimezoneApiInterface.tokenKey).
              and.not.to.be.undefined().
              and.to.be.a.string().
              and.to.equal("fakeGoogleTokenKey");
          });
        ...
        suite(`url`, () => {
          ...
          test(`should be assigned the correct value`, async () => {
            ...
            expect(fakeDefaultTimezoneApiInterface).
              and.not.to.be.undefined().
              and.to.be.instanceof(FakeTimezoneApi);
            expect(fakeDefaultTimezoneApiInterface.url).
              and.not.to.be.undefined().
              and.to.be.a.string().
              and.to.equal("fake://maps.googleapis.com/maps/api/timezone/json");
          });
        });
      });
